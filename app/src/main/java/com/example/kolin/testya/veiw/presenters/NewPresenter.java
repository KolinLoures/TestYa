...
public class NewPresenter extends BaseFavoritePresenter<NewFragment> {

    private static final String TAG = NewPresenter.class.getSimpleName();
    ...
    @Override
    public void attacheView(@NonNull NewFragment view) {
    ...
    public void loadTranslationFromDb(@TypeSaveTranslation.TypeName String type, int spinnerPos) {
        ...
        getTranslationsDb.clearDisposableObservers();

        getTranslationsDb.execute(new NewTranslationDbObserver(),
    ...
    private final class NewTranslationDbObserver extends DisposableObserver<List<InternalTranslation>> {
    ...
    private final class DeleteObserver extends DisposableObserver<Boolean> {
